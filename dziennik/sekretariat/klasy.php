...
<head>
    <meta charset="UTF-8">
    <title>Konfiguracja Klasy (Sekretariat)</title>
    <style>
...
<div class="container">
    <div class="top-bar">
        <a href="sekretariat.php" class="btn-powrot">← Powrót</a>
    </div>

    <h1 style="text-align:center;">Konfiguracja Klasy (Sekretariat)</h1>
